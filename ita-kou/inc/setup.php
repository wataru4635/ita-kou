...
function enqueue_custom_scripts() {
    ...
    if (is_page('contact') || is_page_template('page-contact.php')) {
        // 郵便番号→住所 自動入力（AjaxZip3）
        wp_enqueue_script('ajaxzip3', 'https://ajaxzip3.github.io/ajaxzip3.js', [], '20240101', $in_footer);
        wp_enqueue_script('form-script', "{$asset_uri}/js/form.js", ['ajaxzip3'], $get_ver("{$theme_path}/assets/js/form.js"), $in_footer);
    }

    // 設備紹介（サムネイル切替ギャラリー）
    if (is_page('facilities') || is_page_template('page-facilities.php')) {
        wp_enqueue_script('facilities-script', "{$asset_uri}/js/facilities.js", [], $get_ver("{$theme_path}/assets/js/facilities.js"), $in_footer);
    }
...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@300;400;500;600;700&display=swap" rel="preload"
